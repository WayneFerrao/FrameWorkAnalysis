    ...
    return (<div>
      ...
      <PageContent>
        ...
        <Card style={{
          ...
          <CardMedia style={{
              objectFit: "cover"
            }} component="img" alt="Sample" height="180" image="https://thumbs.dreamstime.com/z/online-robber-17098197.jpg" title="Sample"/>
        ...
        <Content>This is an example of a card. Cards are a simple and aesthetically pleasing way to display content and actions on a single topic. They contain actions and elements like text and images.
        </Content>
        ...
        <Content>To add an image to your Card you can use CardMedia with an img tag inside that directs to your image.
        </Content>
        <CodeBlock>
          {`<Card>`}
          <br/>
        ...
        <Content>To add a title or description to your card use the {`<CardContent>`} component along with {`<Typography>`} and either {`<h1>`} or {`<p>`} tags for the title and description.
        </Content>
        <CodeBlock>
          {`<Card>`}
          <br/>
...
<br/>
        ...
        <Content>
        Finally, to format the layout of the page, there are three simple things you can use to make your webpage look cleaner and less cluttered.
        </Content>
        <SubHeader id="grid">
          Grids
        </SubHeader>
        ...
        All you need to do now is call the tag listen below, and place the components you want centered in between:
...
<Content>
To differentiate different parts of a webpage, you can simply insert a thematic break by using the thematic break tag:
</Content>
<CodeBlock>
{`// Header Section`}
<br/>
